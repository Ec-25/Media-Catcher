...
"                      <html><head/><body><p>Download</p></body></html>", None))
        ...
        self.ob_fvideo.setItemText(0, QCoreApplication.translate("MainWindow", u"mp4", None))
        self.ob_fvideo.setItemText(1, QCoreApplication.translate("MainWindow", u"mov", None))
        self.ob_fvideo.setItemText(2, QCoreApplication.translate("MainWindow", u"webm", None))
        self.ob_fvideo.setItemText(3, QCoreApplication.translate("MainWindow", u"flv", None))
        self.ob_fvideo.setItemText(4, QCoreApplication.translate("MainWindow", u"mkv", None))
        self.ob_fvideo.setItemText(5, QCoreApplication.translate("MainWindow", u"avi", None))

        self.ob_faudio.setItemText(0, QCoreApplication.translate("MainWindow", u"aac", None))
        self.ob_faudio.setItemText(1, QCoreApplication.translate("MainWindow", u"m4a", None))
        self.ob_faudio.setItemText(2, QCoreApplication.translate("MainWindow", u"mp3", None))
        self.ob_faudio.setItemText(3, QCoreApplication.translate("MainWindow", u"ogg", None))
        self.ob_faudio.setItemText(4, QCoreApplication.translate("MainWindow", u"opus", None))
        self.ob_faudio.setItemText(5, QCoreApplication.translate("MainWindow", u"webm", None))
        self.ob_faudio.setItemText(6, QCoreApplication.translate("MainWindow", u"wav", None))
